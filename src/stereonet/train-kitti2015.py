...
def parse_train_args() -> argparse.Namespace:
    ...
    parser.add_argument('--kitti_root', type=Path, help="Root path containing the sceneflow folders containing the images and disparities.")
...
def main() -> None:  # pylint: disable=missing-function-docstring
    ...
    train_dataset = utils.Kitti2015Dataset(args.kitti_root, string_exclude='TEST', transforms=train_transforms, mode='train')
    ...
    val_dataset = utils.Kitti2015Dataset(args.kitti_root, string_include='TEST', transforms=val_transforms, mode='val')
